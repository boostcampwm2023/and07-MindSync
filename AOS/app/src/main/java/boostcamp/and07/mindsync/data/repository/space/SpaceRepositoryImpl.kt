...
constructor(private val spaceApi: SpaceApi) : SpaceRepository {
    ...
    override suspend fun getSpace(spaceUuid: String): Flow<Space> = flow {
    ...
    override suspend fun getInviteSpaceCode(spaceUuid: String): Flow<String> = flow {
    ...
    override suspend fun joinInviteCode(inviteCode: String): Flow<Space> = flow {
